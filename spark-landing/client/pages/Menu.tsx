  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (contentContainer) {
        ...
        console.log('Menu scroll detected on content container:', currentScrollY);
        ...
        console.log('Menu scroll detected on window:', currentScrollY);
        setScrollY(currentScrollY);
      }
    };
    ...
    if (contentContainer) {
      ...
      console.log('Menu scroll listener attached to content container');
    } else {
      // Fallback to window scroll
      window.addEventListener('scroll', handleScroll, { passive: true });
      console.log('Menu scroll listener attached to window');
    }
