  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (contentContainer) {
        ...
        console.log('Reservations scroll detected on content container:', currentScrollY);
        ...
        console.log('Reservations scroll detected on window:', currentScrollY);
        setScrollY(currentScrollY);
      }
    };
    ...
    if (contentContainer) {
      ...
      console.log('Reservations scroll listener attached to content container');
    } else {
      // Fallback to window scroll
      window.addEventListener('scroll', handleScroll, { passive: true });
      console.log('Reservations scroll listener attached to window');
    }
